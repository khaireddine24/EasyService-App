...
export const Categories = [
    { id: 1, label: 'Bricolage', allowed: true },
    { id: 2, label: 'Jardinage', allowed: false },
    { id: 3, label: 'Ménage', allowed: false },
    { id: 4, label: 'Déménagement', allowed: false },
    { id: 5, label: 'Informatique', allowed: false },
    { id: 6, label: 'Aide à domicile', allowed: false },
    { id: 7, label: 'Cours particuliers', allowed: false },
    { id: 8, label: 'Enfants', allowed: false },
    { id: 9, label: 'Animaux', allowed: false }
  ];
